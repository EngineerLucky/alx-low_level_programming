...
/**
 * interval - prints a function that checks
 * if the linked list has not looped
 * @begin: the begining of the list
 * @node: current node
 * @i: interval that should be at current position
...
/**
 * print_listint_safe - writes a function that
 * prints a listint_t linked list
 * @head: listint_t argument (head)
 * Return: numba of nodes in the list
 */
